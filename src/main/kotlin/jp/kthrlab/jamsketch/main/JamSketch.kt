...
class JamSketch : SimplePianoRoll(), IConfigAccessible {
    ...
    companion object {
        const val PACKAGE_NAME: String = "jp.kthrlab.jamsketch.main"
    }
...
//        model!!.curve.clear()
    ...
    // ControlP5
    fun loadCurve(pApplet: PApplet) {
        pApplet.selectInput("Select a file to process:", "loadFileSelected")
    }

// TODO: Delete after comfirmation
...
//            musicData.updateCurve("all")
    ...
    fun makeLog(action: String) {
        jp.kthrlab.jamsketch.main.makeLog(action, musicData, config.general.log_dir, this)
    }

}

fun main() {
    PApplet.runSketch(arrayOf("jp.jamsketch.main.JamSketch"), jp.kthrlab.jamsketch.main.JamSketch())
}
