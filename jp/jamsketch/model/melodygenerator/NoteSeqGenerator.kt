...
//    private val engine: IMelodyGenerateEngine,
    ...
    private val entropy_mean = model["entropy.mean"] as Double
    private val w1 = 0.5
    private val w2 = 0.8
    private val w3 = 1.2
    private val w4 = 2.0
    private val RHYTHM_THRS = 0.1
    private val RHYTHM_WEIGHTS =  listOf(1.0, 0.2, 0.4, 0.8, 0.2, 0.4, 1.0, 0.2, 0.4, 0.8, 0.2, 0.4)
